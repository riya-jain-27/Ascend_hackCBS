                        ...
                        <div class="screen">
                            <div class="screen__content">
                                <div style={{padding: "20px", paddingLeft: "22px"}}>
                                    <h4 style={{color: "#c66021"}}>Not a member yet? <span style={{textDecoration: "underline", fontWeight: "800", cursor: "pointer"}} onClick={signinCompany}>Sign Up</span></h4>
                                </div>
                                <form class="login">
                                    <div style={{paddingBottom: "20px"}}>
                                        <h2 style={{color: "#c66021"}}>Company Login</h2>
                                    </div>
